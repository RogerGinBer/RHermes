...
setMethod("ppm", "ExpParam", function(x) {
    x@ppm
})
setMethod("ppm<-", "ExpParam", function(x, value) {
    x@ppm <- value
    x
})
...
setGeneric("res<-", function(x, value) {
    standardGeneric("res<-")
})
setMethod("res", "ExpParam", function(x) {
    x@res
})
setMethod("res<-", "ExpParam", function(x, value) {
    x@res <- value
    x
})
...
#' @export nthr
#' @export nthr<-
setGeneric("nthr", function(x) {
    standardGeneric("nthr")
})
setGeneric("nthr<-", function(x, value) {
    standardGeneric("nthr<-")
})
setMethod("nthr", "ExpParam", function(x) {
    x@nthr
})
setMethod("nthr<-", "ExpParam", function(x, value) {
    x@nthr <- value
    x
})
...
#' @export minmz
#' @export minmz<-
setGeneric("minmz", function(x) {
    standardGeneric("minmz")
})
setGeneric("minmz<-", function(x, value) {
    standardGeneric("minmz<-")
})
setMethod("minmz", "ExpParam", function(x) {
    x@minmz
})
setMethod("minmz<-", "ExpParam", function(x, value) {
    x@minmz <- value
    x
})
...
#' @export maxmz
#' @export maxmz<-
setGeneric("maxmz", function(x) {
    standardGeneric("maxmz")
})
setGeneric("maxmz<-", function(x, value) {
    standardGeneric("maxmz<-")
})
setMethod("maxmz", "ExpParam", function(x) {
    x@maxmz
})
setMethod("maxmz<-", "ExpParam", function(x, value) {
    x@maxmz <- value
    x
})
...
#' @export ion
#' @export ion<-
setGeneric("ion", function(x) {
    standardGeneric("ion")
})
setGeneric("ion<-", function(x, value) {
    standardGeneric("ion<-")
})
setMethod("ion", "ExpParam", function(x) {
    x@ion
})
setMethod("ion<-", "ExpParam", function(x, value) {
    x@ion <- value
    x
})
...
#' @export DB
#' @export DB<-
setGeneric("DB", function(x) {
    standardGeneric("DB")
})
setGeneric("DB<-", function(x, value) {
    standardGeneric("DB<-")
})
setMethod("DB", "ExpParam", function(x) {
    x@DB
})
setMethod("DB<-", "ExpParam", function(x, value) {
    x@DB <- value
    x
})
...
#' @export adlist
#' @export adlist<-
setGeneric("adlist", function(x) {
    standardGeneric("adlist")
})
setGeneric("adlist<-", function(x, value) {
    standardGeneric("adlist<-")
})
setMethod("adlist", "ExpParam", function(x) {
    x@adlist
})
setMethod("adlist<-", "ExpParam", function(x, value) {
    x@adlist <- value
    x
})
...
#' @export specs
#' @export specs<-
setGeneric("specs", function(x) {
    standardGeneric("specs")
})
setGeneric("specs<-", function(x, value) {
    standardGeneric("specs<-")
})
setMethod("specs", "SOIParam", function(x) {
    x@specs
})
setMethod("specs<-", "SOIParam", function(x, value) {
    x@specs <- value
    x
})
...
#' @export maxlen
#' @export maxlen<-
setGeneric("maxlen", function(x) {
    standardGeneric("maxlen")
})
setGeneric("maxlen<-", function(x, value) {
    standardGeneric("maxlen<-")
})
setMethod("maxlen", "SOIParam", function(x) {
    x@maxlen
})
setMethod("maxlen<-", "SOIParam", function(x, value) {
    x@maxlen <- value
    x
})
...
#' @export minint
#' @export minint<-
setGeneric("minint", function(x) {
    standardGeneric("minint")
})
setGeneric("minint<-", function(x, value) {
    standardGeneric("minint<-")
})
setMethod("minint", "SOIParam", function(x) {
    x@minint
})
setMethod("minint<-", "SOIParam", function(x, value) {
    x@minint <- value
    x
})
...
#' @export mzneigh
#' @export mzneigh<-
setGeneric("mzneigh", function(x) {
    standardGeneric("mzneigh")
})
setGeneric("mzneigh<-", function(x, value) {
    standardGeneric("mzneigh<-")
})
setMethod("mzneigh", "SOIParam", function(x) {
    x@mzneigh
})
setMethod("mzneigh<-", "SOIParam", function(x, value) {
    x@mzneigh <- value
    x
})
...
#' @export rtneigh
#' @export rtneigh<-
setGeneric("rtneigh", function(x) {
    standardGeneric("rtneigh")
})
setGeneric("rtneigh<-", function(x, value) {
    standardGeneric("rtneigh<-")
})
setMethod("rtneigh", "SOIParam", function(x) {
    x@rtneigh
})
setMethod("rtneigh<-", "SOIParam", function(x, value) {
    x@rtneigh <- value
    x
})
...
#' @export blanksub
#' @export blanksub<-
setGeneric("blanksub", function(x) {
    standardGeneric("blanksub")
})
setGeneric("blanksub<-", function(x, value) {
    standardGeneric("blanksub<-")
})
setMethod("blanksub", "SOIParam", function(x) {
    x@blanksub
})
setMethod("blanksub<-", "SOIParam", function(x, value) {
    x@blanksub <- value
    x
})
