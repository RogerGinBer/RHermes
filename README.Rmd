...
width = "250px" height = "250px" src = "`r system.file("extdata/stickerNoBioc.svg", package = "RHermes")`">
...
you can focus on just the compounds you are interested in.
