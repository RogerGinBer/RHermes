...
RHermes::IsoFidelity(waterPosUnfiltered, soilist = 6,
                     entry = which(waterPosUnfiltered@data@SOI[[6]]@SoiList$formula == chloridazon)[2], plot = T)

alphaC <- "[C11H9KN3]+"
RHermes::IsoFidelity(waterPosUnfiltered, soilist = 6,
                     entry = which(waterPosUnfiltered@data@SOI[[6]]@SoiList$formula == alphaC)[2], plot = T)
...
anotatedSL <- RHermes:::anotateISF(waterPosUnfiltered@data@SOI[[6]]@SoiList, DB, polarity = 1,
                                   BiocParallelParam = SnowParam(4, progressbar = T))
