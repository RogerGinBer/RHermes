...
# myHermes <- MS2Proc(myHermes, 1, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", mincos = 0.5, useDB = TRUE, sstype = "regular")
myHermes <- MS2Proc(myHermes, 2, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", mincos = 0.5, useDB = TRUE, sstype = "regular")
...
# negHermes <- MS2Proc(negHermes, 1, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", mincos = 0.5, useDB = TRUE, sstype = "regular")
negHermes <- MS2Proc(negHermes, 2, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", mincos = 0.5, useDB = TRUE, sstype = "regular")
