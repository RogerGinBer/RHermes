...
saveRDS(myHermes, file = "D:/ABrunner/MS1_pos_Ident_Water.rds")
...
negHermes <- MS2Proc(negHermes, 1, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", useDB = TRUE, mincos = 0.5)
negHermes <- MS2Proc(negHermes, 2, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", useDB = TRUE, mincos = 0.5)


ms2f <- list.files("D:/ABrunner/MSMSdata", pattern = ".*neg.*.mzML", full.names = TRUE)[seq(35,45)]
negHermes <- MS2Proc(negHermes, 3, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", useDB = TRUE, mincos = 0.5)
negHermes <- MS2Proc(negHermes, 4, MS2files = ms2f, referenceDB = "D:/MS2ID_B2R_20201113_083214.rds", useDB = TRUE, mincos = 0.5)
