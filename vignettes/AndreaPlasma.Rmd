...
myHermes <- MS2Proc(myHermes, 1, MS2files = ms2f, referenceDB = "D:/sp_MS2ID_RogerGB.RData", mincos = 0.8)
myHermes <- MS2Proc(myHermes, 2, MS2files = ms2f, referenceDB = "D:/sp_MS2ID_RogerGB.RData", mincos = 0.8)
saveRDS(myHermes, file = "D:/ABrunner Plasma/MS1_pos_ident.rds")
...
negHermes <- MS2Proc(negHermes, 1, MS2files = ms2f, referenceDB = "D:/sp_MS2ID_RogerGB.RData", mincos = 0.8)
negHermes <- MS2Proc(negHermes, 2, MS2files = ms2f, referenceDB = "D:/sp_MS2ID_RogerGB.RData", mincos = 0.8)
saveRDS(negHermes, file = "D:/ABrunner Plasma/MS1_neg_ident.rds")
